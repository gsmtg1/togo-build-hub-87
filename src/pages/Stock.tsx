...
export default function Stock() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const productData = {
      ...
      prix_unitaire: 0, // Prix calculé par le module de calcul
    ...
    <div className="space-y-6">
                ...
                <div>
                  ...
                  <Select value={formData.categorie} onValueChange={(value) => setFormData({ ...formData, categorie: value })}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="creuse">Creuse</SelectItem>
                      <SelectItem value="decorative">Décorative</SelectItem>
                      <SelectItem value="refractaire">Réfractaire</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Gérez votre inventaire de briques
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
                  ...
                  <TableRow key={product.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <span>{product.stock_actuel}</span>
